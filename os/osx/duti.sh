...
then
	...
	for EXT in bib cdb css htm html json log m macosx mata md mdown markdown osx php py public.plain-text public.unix-executable r rb ris sh shtm shtml statalog sty tex tm_properties txt xml
	do
